                ...
                return TypeAheadField(
                  ...
                  itemBuilder: (BuildContext context, itemData) {
                    return ListTile(
                        ...
                        subtitle: Text((itemData.addresscomponent1!=null)?"${itemData.addresscomponent1}, ${itemData.placeCityName}, ${itemData.placeStateName}".trim():"${itemData.placeCityName}, ${itemData.placeStateName}".trim())
                    );
                  },
                  itemSeparatorBuilder: (context, index) => Divider(height: 0,color: grey,thickness: 0.5),
                  noItemsFoundBuilder: (context) => Container(
                    height: 80,
                    child: Center(
                        child : Text('No Item Found, Try Picking From Map')
                    ),
                  ),
